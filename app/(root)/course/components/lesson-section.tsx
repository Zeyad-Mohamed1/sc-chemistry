    ...
    <>
        ...
        <div className="smooth font-bold text-2xl space-y-6">
          <div className="font-bold clr-text-primary py-5 text-4xl">
            <div className="relative">
              ...
              <span className="">
                <span className="clr-text-primary smooth">محتوى </span>
                <span className="text-primary smooth">الكورس </span>
              </span>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="smooth bg-opacity-50 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10 mx-auto">
